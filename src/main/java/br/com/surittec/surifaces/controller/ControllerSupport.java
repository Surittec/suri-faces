 ...
 */
package br.com.surittec.surifaces.controller;
...
public abstract class ControllerSupport implements Serializable {
	...
	/**
	 * Util para saber se a controladora ja foi inicializada. Voce devera
	 * informar a inicializacao manualmente
	 * 
	 * @return
	 */
	...
	/**
	 * Acao invocada sempre que a tela for iniciada. Retorne nulo para seguir
	 * para a tela ou retorne uma viewId para redirecionar para outra tela
	 * 
	 * @return
	 */
	@RequestAction
	...
	/**
	 * Metodo para ser utilizado em acoes de cancelamento que exigem a limpeza
	 * de um form. Realiza, assim, a limpeza completa na arvore de componentes
	 * do JSF, do form que o botao se encontra.
	 * 
	 * @param event
	 */
	public void resetForm(ActionEvent event) {
		UIComponent component = event.getComponent();
		while (!(component instanceof HtmlForm) && component.getParent() != null)
