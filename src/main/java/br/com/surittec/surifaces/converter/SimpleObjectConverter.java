...
@FacesConverter("br.com.surittec.surifaces.converter.SimpleObjectConverter")
public class SimpleObjectConverter implements Converter {

	private static final String OBJECT_VALUES = SimpleObjectConverter.class.getName() + ".OBJECT_VALUES";
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		...
		if (objectValues == null) {
			...
			component.getAttributes().put(OBJECT_VALUES, objectValues);
		}
