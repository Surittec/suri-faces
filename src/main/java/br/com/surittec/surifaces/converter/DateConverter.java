 ...
 *
 */
@FacesConverter("br.com.surittec.surifaces.converter.DateConverter")
public class DateConverter implements Converter {

	private static final String PATTERN = DateConverter.class.getName() + ".PATTERN";
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		if (value == null)
			return null;
		return new SimpleDateFormat((String) component.getAttributes().get(PATTERN)).format((Date) value);
	}
