 ...
 */
package br.com.surittec.surifaces.facelets.function;
...
public class FaceletsFunctions {
	...
	public static java.lang.String getInputNumberMask(java.lang.String locale, java.lang.Object integerDigits, java.lang.Object fractionDigits) {
		...
		for (int i = 0; i < InputNumberTag.getFractionDigits(fractionDigits); i++)
			mask.append("9");
		if (mask.length() > 0)
			mask.append(symbols.getDecimalSeparator());
	...
	public static java.lang.String getInputNumberValidValue(java.lang.Object fractionDigits) {
		StringBuilder mask = new StringBuilder();
		for (int i = 0; i < InputNumberTag.getFractionDigits(fractionDigits) + 1; i++)
			mask.append("0");
		return mask.toString();
	}
